///
/// Example: Hello World!    {#examples_hello_c}
/// =====================
///
...
/// the master process.
///
/// Having done the work we set out to do, we will now delete the PIOL object.
/// This step is important to ensure files and caches are shut down properly
