...
class Inspector_segy_file {
  ...
  public:
    ...
    exseis::IO_driver io_driver() const
    {
        ...
        return exseis::IO_driver_distributed_vector{
...
TEST_CASE("Output_file_segy", "[Output_file_segy][Output_file][PIOL]")
{
    ...
    auto number_encoding = exseis::segy::Segy_number_format::IEEE_fp32;
    ...
    exseis::Output_file_segy output_file_segy{inspector.io_driver()};
    ...
    output_file_segy.write_sample_interval(
        ...
        * exseis::Output_file_segy::Options{}.sample_interval_factor);
    ...
    SECTION ("File Metadata") {
        ...
        exseis::Input_file_segy input_file_segy{std::move(io_drivers[0])};
...

        {
            ...
            REQUIRE(
                ...
                == segy_file_sample_interval
                       * exseis::Output_file_segy::Options{}
    ...
    SECTION ("File Traces") {
            ...
            [&](size_t trace_index, size_t trace_buffer_index,
                ...
                REQUIRE(std::equal(
                    ...
                    samples_i.cend(), [](auto t, auto s) {
                        ...
                        return exseis::to_big_endian(t)
                               == exseis::to_big_endian(s);
                    }));
            };
        ...
        SECTION ("Output_file_segy::write_*_non_contiguous()") {
            ...
            const exseis::Input_file_segy input_file_segy{
                std::move(io_drivers[0])};
