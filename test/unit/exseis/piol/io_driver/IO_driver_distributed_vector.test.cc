...
class Inspector_io_driver_distributed_vector {
  public:
    ...
    static Distributed_vector make_storage(size_t file_size)
    {
        ...
        return exseis::Distributed_vector_mpi<unsigned char>{
            Inspector_io_driver_distributed_vector::communicator(), file_size};
    }

    static exseis::IO_driver_distributed_vector set_pattern(
        exseis::IO_driver_distributed_vector&& io_driver_distributed_vector)
    {
    ...
    static void for_each(
        const exseis::IO_driver_distributed_vector&
    ...
    static size_t file_size(const exseis::IO_driver_distributed_vector&
                                io_driver_distributed_vector)
    {
...
struct Cache {
    exseis::Distributed_vector<unsigned char> distributed_vector =
    ...
    "[IO_driver_distributed_vector][IO_driver][Distributed_vector][PIOL][2GB Limit]")
{
    ...
    exseis::IO_driver_distributed_vector io_driver(
        exseis::Distributed_vector_mpi<unsigned char>(communicator, file_size));
