...
const exseis_SortType sort_types[] = {
    exseis_sorttype_SrcRcv,   exseis_sorttype_SrcOff,
    exseis_sorttype_SrcROff,  exseis_sorttype_RcvOff,
    exseis_sorttype_RcvROff,  exseis_sorttype_LineOff,
    exseis_sorttype_LineROff, exseis_sorttype_OffLine,
...
const exseis_Gain_function agc_types[] = {
    exseis_rectangular_rms_gain, exseis_triangular_rms_gain,
    exseis_mean_abs_gain, exseis_median_gain};
...
int main()
{
    ...
    */
    ...
    if (fabs(piol_file_get_prm_double(380, exseis_meta_Copy, param) - 390.0)
        < 1e-5) {
        wraptest_ok();
    }
    ...
    */
    ...
    if (fabs(piol_file_read_interface_read_sample_interval(read_direct) - 620.0)
        < 1e-5) {
        wraptest_ok();
    };
