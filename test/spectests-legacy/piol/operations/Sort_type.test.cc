...
TEST(Sort_type, C_API)
{
    ...
    static_assert(
        std::is_same<
            std::underlying_type<Sort_type>::type,
            exseis::piol::exseis_SortType>::value,
