...
TEST(Trace_header_offsets, C_API)
{
    ...
    static_assert(
        std::is_same<
            ...
            exseis_Trace_header_offsets>::value,
    ...
    switch (Trace_header_offsets::SeqNum) {
        ...
        case Trace_header_offsets::SeqNumEns:
            static_assert(
                Trace_header_offsets::SeqNumEns == exseis_tr_SeqNumEns,
        ...
        case Trace_header_offsets::HStackCnt:
            static_assert(
                Trace_header_offsets::HStackCnt == exseis_tr_HStackCnt,
        ...
        case Trace_header_offsets::SurfElvSrc:
            static_assert(
                Trace_header_offsets::SurfElvSrc == exseis_tr_SurfElvSrc,
        ...
        case Trace_header_offsets::SrcDpthSurf:
            static_assert(
                Trace_header_offsets::SrcDpthSurf == exseis_tr_SrcDpthSurf,
        ...
        case Trace_header_offsets::DtmElvRcv:
            static_assert(
                Trace_header_offsets::DtmElvRcv == exseis_tr_DtmElvRcv,
        ...
        case Trace_header_offsets::DtmElvSrc:
            static_assert(
                Trace_header_offsets::DtmElvSrc == exseis_tr_DtmElvSrc,
        ...
        case Trace_header_offsets::WtrDepSrc:
            static_assert(
                Trace_header_offsets::WtrDepSrc == exseis_tr_WtrDepSrc,
        ...
        case Trace_header_offsets::WtrDepRcv:
            static_assert(
                Trace_header_offsets::WtrDepRcv == exseis_tr_WtrDepRcv,
        ...
        case Trace_header_offsets::ScaleElev:
            static_assert(
                Trace_header_offsets::ScaleElev == exseis_tr_ScaleElev,
        ...
        case Trace_header_offsets::ScaleCoord:
            static_assert(
                Trace_header_offsets::ScaleCoord == exseis_tr_ScaleCoord,
        ...
        case Trace_header_offsets::ShotScal:
            static_assert(
                Trace_header_offsets::ShotScal == exseis_tr_ShotScal,
        ...
        case Trace_header_offsets::ValMeas:
            static_assert(
                Trace_header_offsets::ValMeas == exseis_tr_ValMeas,
        ...
        case Trace_header_offsets::TransUnit:
            static_assert(
                Trace_header_offsets::TransUnit == exseis_tr_TransUnit,
        ...
        case Trace_header_offsets::TimeScal:
            static_assert(
                Trace_header_offsets::TimeScal == exseis_tr_TimeScal,
        ...
        case Trace_header_offsets::SrcMeas:
            static_assert(
                Trace_header_offsets::SrcMeas == exseis_tr_SrcMeas,
        ...
        case Trace_header_offsets::SrcMeasExp:
            static_assert(
                Trace_header_offsets::SrcMeasExp == exseis_tr_SrcMeasExp,
