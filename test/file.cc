...
struct FakeFile : public File::Interface
{
    ...
    void writeCoordPoint(File::Coord item, csize_t i, const File::coord_t coord) const {}
    void writeGridPoint(File::Grid item, csize_t i, const File::grid_t grid) const {}
};
