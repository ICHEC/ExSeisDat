...
const std::complex<trace_t> I(0,1);
...
typedef std::function<trace_t(trace_t *, size_t, size_t, size_t)> FltrPad;  //!< Typedef for filter padding funcitons
     ...
     * return Filter order
     */
    size_t filterOrder(trace_t conerP, trace_t cornerS, trace_t fs);
     ...
     * \param[in] numer Array of polynomial coefficiences in the numerator of filter transfer function
     ...
     */
    void makeFiter(FltrType type, trace_t * numer, trace_t * denom, size_t N, trace_t cf1, trace_t cf2);
