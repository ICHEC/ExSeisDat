...
/// @file
////////////////////////////////////////////////////////////////////////////////
#ifndef EXSEIS_UTILS_DISTRIBUTED_VECTOR_DISTRIBUTED_VECTOR_HH
#define EXSEIS_UTILS_DISTRIBUTED_VECTOR_DISTRIBUTED_VECTOR_HH
...
class Distributed_vector {
  ...
  public:
    /// @brief Constructor passes instance of Implementation to the
    ///        `m_implementation` member variable.
    ///
    /// This is intended to be the point of entry for inheriting classes.
    ///
    /// @param[in] implementation The inherited and specialized Implementation
    ///                    class defined by a child class.
    Distributed_vector(std::unique_ptr<Implementation> implementation) :
    ...
    {
        m_implementation->get_n(offset, count, buffer);
    }
    ...
    {
        m_implementation->set_n(offset, count, buffer);
    }
    ...
    void resize(size_t new_size) { m_implementation->resize(new_size); }

    /// @brief Make writes visible to all processes
    void sync() { m_implementation->sync(); }

    /// @brief Get the communicator the Distributed_vector is defined over
    /// @returns The underlying communicator
    Communicator communicator() const
    {
        return m_implementation->communicator();
    }
    ...
    /// A specialized instance of this `Implementation` class should then be
    ...
    class Implementation {
      public:
        ...
        /// @copydoc Distributed_vector::communicator
        virtual Communicator communicator() const = 0;
    };
};
...
#endif  // EXSEIS_UTILS_DISTRIBUTED_VECTOR_DISTRIBUTED_VECTOR_HH
