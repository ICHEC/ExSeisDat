...
////////////////////////////////////////////////////////////////////////////////
#ifndef EXSEIS_PIOL_IO_DRIVER_IO_DRIVER_DISTRIBUTED_VECTOR_HH
#define EXSEIS_PIOL_IO_DRIVER_IO_DRIVER_DISTRIBUTED_VECTOR_HH
...
class IO_driver_distributed_vector : public IO_driver {
  public:
    ...
    using Distributed_vector = exseis::Distributed_vector<unsigned char>;

    /// @brief Build an IO_driver from an instance of Distributed_vector.
    ///
    ...
    {
        std::unique_ptr<IO_driver::Implementation> impl =
        ...
        return std::move(*impl_dv).distributed_vector();
    }

    /// @brief Polymorphic implementation of an IO_driver using a
    ///        Distributed_vector as storage.
    class Implementation : public IO_driver::Implementation {
      ...
      public:
        /// @copydoc IO_driver_distributed_vector::IO_driver_distributed_vector
        ...
        {
            return "<IO_driver_distributed_vector>";
        }
        ...
        {
            return m_distributed_vector.communicator();
        }

        /// @copydoc IO_driver_distributed_vector::distributed_vector() &&
        const Distributed_vector& distributed_vector() const&
        {
            return m_distributed_vector;
        }

        /// @copydoc IO_driver_distributed_vector::distributed_vector() &&
        Distributed_vector distributed_vector() &&
        {
            return std::move(m_distributed_vector);
        }
    };
};
...
#endif  // EXSEIS_PIOL_IO_DRIVER_IO_DRIVER_DISTRIBUTED_VECTOR_HH
