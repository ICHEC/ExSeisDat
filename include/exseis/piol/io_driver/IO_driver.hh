...
////////////////////////////////////////////////////////////////////////////////
#ifndef EXSEIS_PIOL_IO_DRIVER_IO_DRIVER_HH
#define EXSEIS_PIOL_IO_DRIVER_IO_DRIVER_HH
...
class IO_driver {
  ...
  public:
    ...
    /// @brief Get the file name / resource name
    /// @return Returns the file name / resource name
    ...
    /// @brief Get the communicator for the file
    /// @returns The communicator for the file
    ...
    class Implementation {
      public:
        ...
        /// @copydoc IO_driver::communicator
...
#endif  // EXSEIS_PIOL_IO_DRIVER_IO_DRIVER_HH
