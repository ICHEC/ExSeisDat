...
typedef exseis::piol::Rule piol_file_rule;

/// @copydoc exseis::piol::Trace_metadata
typedef exseis::piol::Trace_metadata piol_file_trace_metadata;

/// @copydoc exseis::piol::ReadInterface
typedef exseis::piol::ReadInterface piol_file_read_interface;

/// @copydoc exseis::piol::WriteInterface
typedef exseis::piol::WriteInterface piol_file_write_interface;
 ...
 *      default rules)
 *      A copy of this pointer is stored in piol_file_trace_metadata, but it's
 * safe to call piol_file_rule_delete(rule) before deleting this, because the
 ...
 */
typedef struct {
    /// The interval factor which should be used with sample_interval.
