...
/// @brief
////////////////////////////////////////////////////////////////////////////////
#ifndef EXSEISDAT_UTILS_SIGNAL_PROCESSING_TEMPORALFILTER_HH
#define EXSEISDAT_UTILS_SIGNAL_PROCESSING_TEMPORALFILTER_HH
...
/// @name Temporal Filter Functions
/// @{

/*! @brief Determines the filter order if given passband and stopband
 * frequecnies
...
/*! @brief Expands a series of polynomials of the form (z-b0)(z-b1)...(z-bn)
...
/*! @brief Creates a digital Butterworth lowpass filter for a given corner in
 *         zero/pole/gain form
...
/*! @brief Creates a digital Butterworth highpass filter for a given corner in
 *         zero/pole/gain form
 *  @param[in] n   Filter order
 *  @param[in] z   Vector of filter zeros
 *  @param[in] p   Vector of filter poles
...
/*! @brief Creates a digital Butterworth bandpass filter for a given corner in
 *         zero/pole/gain form
 *  @param[in] n   Filter order
 *  @param[in] z   Vector of filter zeros
 *  @param[in] p   Vector of filter poles
...
/*! @brief Creates a digital Butterworth bandstop filter for a given corner in
 *         zero/pole/gain form
 *  @param[in] n   Filter order
 *  @param[in] z   Vector of filter zeros
 *  @param[in] p   Vector of filter poles
...
/*! @brief Creates a discrete, digital Butterworth filter for a given corner in
...
/*! @brief Get the pattern for padding traces for filtering
 *  @param[in] type Type of padding
 *  @return function for padding trace
 */
FltrPad get_pad(PadType type);

/*! @brief Filter trace in frequency domain
...
/*! @brief Filter trace in time domain
...
/*! @brief Temporally filter traces when given passband and stopband frequencies
...
/*! @brief Temporally filter traces when given passband frequencies and filter
 *         Order
 *  @param[in] nt      Number of traces
 *  @param[in] ns      Number of samples per trace
 *  @param[in] trc     Traces
...
#endif  // EXSEISDAT_UTILS_SIGNAL_PROCESSING_TEMPORALFILTER_HH
