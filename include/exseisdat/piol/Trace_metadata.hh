...
///          structure.
////////////////////////////////////////////////////////////////////////////////
#ifndef EXSEISDAT_PIOL_TRACE_METADATA_HH
#define EXSEISDAT_PIOL_TRACE_METADATA_HH
...
/// Class for initialising the trace parameter structure
...
class Trace_metadata {
  public:
    ...
    /// A map for the metadata entry key to the list of entries for each trace
    /// block.
    template<typename T>
    ...
    ///
    /// A common cause for this being thrown is where the key exists in the
    /// metadata structure, but the wrong type has been queried.
    /// e.g. A floating point entry for that key exists, but an integer entry
    ///      for the key is requested.
    ///
  ...
  public:
    ...
    /// Indicates how large an individual raw metadata block is for a trace
    /// block. Used for indexing the `raw_metadata` block.
    ...
    std::map<Key, RuleEntry::MdType> entry_types;
...
#endif  // EXSEISDAT_PIOL_TRACE_METADATA_HH
