...
class Input_file {
  ...
  public:
     ...
     */
    exseis::utils::Floating_point read_sample_interval() const
    {
    ...
    void read_data(
        size_t trace_offset,
        size_t number_of_traces,
        exseis::utils::Trace_value* trace_data) const
    {
     ...
     *                    (size
     * number_of_traces*samples_per_trace*sizeof(exseis::utils::Trace_value))
     */
    ...
    class Implementation {
      public:
        ...
        virtual void read_data(
            size_t trace_offset,
            size_t number_of_traces,
            exseis::utils::Trace_value* trace_data) const = 0;
