...
class Logger
{
    ...
    std::forward_list<Item> loglist_;    //!< The linked-list container which holds the log items
    ...
    const std::forward_list<Item>& loglist() const {
        return loglist_;
    }
     ...
     */
    void record(const std::string file, const Layer layer, const Status stat, const std::string msg,
                const Verbosity verbosity, const bool condition);
