 ...
 */
#define PIOL_META_COPY                                                         \
    ((PIOL_Meta)0)  //!< Copy all headers. Don't interpret them.
...
#define PIOL_META_VStack                                                       \
    ((PIOL_Meta)12)  //!< Number of traces stacked for this trace (vertical)
#define PIOL_META_HStack                                                       \
    ((PIOL_Meta)13)  //!< Number of traces stacked for this trace (horizontal)
...
#define PIOL_META_TransUnit                                                    \
    ((PIOL_Meta)28)  //!< Unit system for transduction constant
#define PIOL_META_TraceUnit ((PIOL_Meta)29)  //!< Unit system for traces
// Non-standard
#define PIOL_META_dsdr                                                         \
    ((PIOL_Meta)30)  //!< The sum of the differences between sources and receivers of this trace and another
...
#define PIOL_TR_SeqNum                                                         \
    ((PIOL_Tr)1U)  //!< int32_t. The trace sequence number in the Line.
#define PIOL_TR_SeqFNum                                                        \
    ((PIOL_Tr)5U)  //!< int32_t. The trace sequence number in SEG-Y File.
#define PIOL_TR_ORF                                                            \
    ((PIOL_Tr)9U)  //!< int32_t. The original field record number.
...
#define PIOL_TR_SeqNumEns                                                      \
    ((PIOL_Tr)25U)  //!< int32_t. The trace number in the ensemble.
#define PIOL_TR_TIC                                                            \
    ((PIOL_Tr)29U)  //!< int16_t. The trace identification number.
#define PIOL_TR_VStackCnt                                                      \
    ((PIOL_Tr)31U)  //!< int16_t. The number of traces vertically stacked.
#define PIOL_TR_HStackCnt                                                      \
    ((PIOL_Tr)33U)  //!< int16_t. The number of traces horizontally stacked.
#define PIOL_TR_CDist                                                          \
    ((PIOL_Tr)37U)  //!< int32_t. The distance from source center to receiver centre.
#define PIOL_TR_RcvElv                                                         \
    ((PIOL_Tr)41U)  //!< int32_t. The receiver group elevation.
#define PIOL_TR_SurfElvSrc                                                     \
    ((PIOL_Tr)45U)  //!< int32_t. The surface elevation at the source.
#define PIOL_TR_SrcDpthSurf                                                    \
    ((PIOL_Tr)49U)  //!< int32_t. The source depth below surface (opposite of above?).
#define PIOL_TR_DtmElvRcv                                                      \
    ((PIOL_Tr)53U)  //!< int32_t. The datum elevation for the receiver group.
#define PIOL_TR_DtmElvSrc                                                      \
    ((PIOL_Tr)57U)  //!< int32_t. The datum elevation for the source.
#define PIOL_TR_WtrDepSrc                                                      \
    ((PIOL_Tr)61U)  //!< int32_t. The water depth for the source.
#define PIOL_TR_WtrDepRcv                                                      \
    ((PIOL_Tr)65U)  //!< int32_t. The water depth for the receive group.
#define PIOL_TR_ScaleElev                                                      \
    ((PIOL_Tr)69U)  //!< int16_t. The scale coordinate for 41-68 (elevations + depths).
#define PIOL_TR_ScaleCoord                                                     \
    ((PIOL_Tr)71U)  //!< int16_t. The scale coordinate for 73-88 + 181-188
#define PIOL_TR_xSrc                                                           \
    ((PIOL_Tr)73U)  //!< int32_t. The X coordinate for the source
#define PIOL_TR_ySrc                                                           \
    ((PIOL_Tr)77U)  //!< int32_t. The Y coordinate for the source
#define PIOL_TR_xRcv                                                           \
    ((PIOL_Tr)81U)  //!< int32_t. The X coordinate for the receive group
#define PIOL_TR_yRcv                                                           \
    ((PIOL_Tr)85U)  //!< int32_t. The Y coordinate for the receive group
#define PIOL_TR_UpSrc                                                          \
    ((PIOL_Tr)95U)  //!< int16_t. The uphole time at the source (ms).
#define PIOL_TR_UpRcv                                                          \
    ((PIOL_Tr)97U)  //!< int16_t. The uphole time at the receive group (ms).
#define PIOL_TR_Ns                                                             \
    ((PIOL_Tr)115U)  //!< int16_t. The number of samples in the trace.
...
#define PIOL_TR_ShotNum                                                        \
    ((PIOL_Tr)197U)  //!< int32_t. The source nearest to the CDP.
#define PIOL_TR_ShotScal                                                       \
    ((PIOL_Tr)201U)  //!< int16_t. The shot number scalar. (Explicitly says that 0 == 1)
#define PIOL_TR_ValMeas                                                        \
    ((PIOL_Tr)203U)  //!< int16_t. The unit system used for trace values.
#define PIOL_TR_TransConst                                                     \
    ((PIOL_Tr)205U)  //!< int32_t. The transduction constant.
#define PIOL_TR_TransExp                                                       \
    ((PIOL_Tr)209U)  //!< int16_t. The transduction exponent.
#define PIOL_TR_TransUnit ((PIOL_Tr)211U)  //!< int16_t. The transduction units
#define PIOL_TR_TimeScal                                                       \
    ((PIOL_Tr)215U)  //!< int16_t. Scalar for time measurements.
#define PIOL_TR_SrcMeas ((PIOL_Tr)225U)  //!< int32_t. Source measurement.
#define PIOL_TR_SrcMeasExp                                                     \
    ((PIOL_Tr)229U)  //!< int16_t. Source measurement exponent.
...
#define PIOL_SORTTYPE_SrcRcv                                                   \
    ((PIOL_SortType)35)  //!< Sort by source x, source y, receiver x, receiver y
#define PIOL_SORTTYPE_SrcOff                                                   \
    ((PIOL_SortType)36)  //!< Sort by source x, source y, calcuated offset
#define PIOL_SORTTYPE_SrcROff                                                  \
    ((PIOL_SortType)37)  //!< Sort by source x, source y, offset read from file
#define PIOL_SORTTYPE_RcvOff                                                   \
    ((PIOL_SortType)38)  //!< Sort by receiver x, receiver y, calculate offset
#define PIOL_SORTTYPE_RcvROff                                                  \
    ((PIOL_SortType)39)  //!< Sort by receiver x, receiver y, offset read from file
#define PIOL_SORTTYPE_LineOff                                                  \
    ((PIOL_SortType)40)  //!< Sort by inline, crossline, calculated offset
#define PIOL_SORTTYPE_LineROff                                                 \
    ((PIOL_SortType)41)  //!< Sort by inline, crossline, offset read from file
#define PIOL_SORTTYPE_OffLine                                                  \
    ((PIOL_SortType)42)  //!< Sort by calculated offset, inline, crossline
#define PIOL_SORTTYPE_ROffLine                                                 \
    ((PIOL_SortType)43)  //!< Sort by offset read from file, inline, crossline
...
#define PIOL_TAPERTYPE_Linear                                                  \
    ((PIOL_TaperType)44)                         //!< Taper using a linear ramp
#define PIOL_TAPERTYPE_Cos ((PIOL_TaperType)45)  //!< Taper using a cos ramp
#define PIOL_TAPERTYPE_CosSqr                                                  \
    ((PIOL_TaperType)46)  //!< Taper using a cos^2 ramp
...
#define PIOL_AGCTYPE_RMS                                                       \
    ((PIOL_AGCType)47)  //!< AGC using RMS with rectangular window
#define PIOL_AGCTYPE_RMSTri                                                    \
    ((PIOL_AGCType)48)  //!< AGC using RMS with triangular window
#define PIOL_AGCTYPE_MeanAbs                                                   \
    ((PIOL_AGCType)49)  //!< AGC using mean absolute value with rectangular window
...
#define PIOL_PARAM_NULL                                                        \
    ((PIOL_Param*)1)  //!< The NULL parameter so that the correct internal read pattern is selected
