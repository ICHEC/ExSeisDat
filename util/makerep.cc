...
std::pair<size_t, size_t> writeArb(size_t rank, size_t numRank, Data::Interface * out, size_t off, size_t bsz, std::pair<size_t, size_t> dec, size_t tsz, std::vector<uchar> * vec)
{
