...
/*! A structure to record a loop starting iteraton and number of iterations (sz).
 *  Used in decomposition of problems.
 */
typedef struct
{
...
typedef void (* ModPrm)(size_t, size_t, PIOL_File_ParamHandle);    //!< Typedef for function which modifies parameters
